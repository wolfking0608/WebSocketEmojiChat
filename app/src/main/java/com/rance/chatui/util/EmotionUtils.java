...
public class EmotionUtils {
    ...
    static {
        ...
        EMPTY_GIF_MAP.put("[微笑]", R.drawable.emotion_weixiao_gif);//[微笑]
        EMPTY_GIF_MAP.put("[撇嘴]", R.drawable.emotion_biezui_gif);//[撇嘴]
        EMPTY_GIF_MAP.put("[色]", R.drawable.emotion_se_gif);//[色]
        EMPTY_GIF_MAP.put("[发呆]", R.drawable.emotion_fadai_gif);//[发呆]
        EMPTY_GIF_MAP.put("[得意]", R.drawable.emotion_deyi_gif);//[得意]
        EMPTY_GIF_MAP.put("[流泪]", R.drawable.emotion_liulei_gif);//[流泪]
